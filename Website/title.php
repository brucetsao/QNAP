...
<table width="100%" border="0">
  <tr>
    <td width="9%"><img src= "images/NCNU_logo_ok.jpg" width="110" height="100" /></td>
    <td width="91%"><img src="images/titlelogo.png" width="800" height="100" /></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr>
 	...
 	<td width="170">
  			<a href="ShowDHT_Chart.php">Teacher example</a>
	</td>
 	<td width="200">
  			<a href="ShowDHT_Guage.php">Teacher example2</a>
	</td>
